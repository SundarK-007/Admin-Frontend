...
const NAV_ITEMS: NavItem[] = [
  { label: "Dashboard", icon: <HomeIcon />, to: "/dashboard" },
  {
    ...
    icon: <ShieldIcon />,
    children: [
      { label: "Admin Users", to: "/users", module: MODULES.users },
      { label: "Customers", to: "/customers", module: MODULES.customers },
      { label: "Roles", to: "/roles", module: MODULES.roles },
      { label: "Permissions", to: "/permissions", module: MODULES.roles },
    ],
  },
