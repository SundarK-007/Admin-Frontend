...
/** Per the client's clarification: lookup accepts email OR mobile, but the reset link always goes to the registered email. */
export default function ForgotPasswordPage() {
  ...
  return (
    <AuthShell
      ...
      footer={
        <Link to="/login" className="text-amber-600 underline-offset-2 hover:underline">
          ← Back to sign in
        </Link>
      }
    >
