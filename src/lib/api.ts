...
const authBaseURL = import.meta.env.VITE_AUTH_API_BASE_URL ?? "http://localhost:5003/api/v1";
const catalogBaseURL = import.meta.env.VITE_API_BASE_URL ?? "http://localhost:5004/api/v1";
